  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="space-y-6">
        <div className="bg-slate-900 text-white p-10 rounded-2xl border border-white/5 relative overflow-hidden group shadow-2xl">
           ...
           <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-400">{user.role}</p>
              </div>
              <div className="pt-6 border-t border-white/5 space-y-4">
                 <div className="flex items-center gap-3">
                   <ShieldCheck size={16} className="text-emerald-500" />
                   <span className="text-[10px] font-bold uppercase tracking-widest text-white/50">Compte Certifié</span>
                 </div>
                 <div className="flex items-center gap-3">
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-2xl overflow-hidden">
           <div className="bg-slate-50 px-8 py-6 border-b border-slate-200 flex items-center justify-between">
              <h3 className="text-lg font-serif font-black uppercase tracking-tighter">Informations Personnelles</h3>
           ...
           <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 group">
                  ...
                  <Input {...profileForm.register("name")} className="rounded-none h-12 border-slate-200 focus-visible:ring-blue-500/10 focus:border-blue-600 transition-all font-bold" />
                ...
                <div className="space-y-2 group">
                  ...
                  <Input {...profileForm.register("email")} className="rounded-none h-12 border-slate-200 focus-visible:ring-blue-500/10 focus:border-blue-600 transition-all font-bold" />
              ...
              <div className="space-y-2 group">
                ...
                <div className="relative">
                  ...
                  <Input {...profileForm.register("phone")} className="pl-10 rounded-none h-12 border-slate-200 focus-visible:ring-blue-500/10 focus:border-blue-600 transition-all font-bold" />
                </div>
              </div>
              ...
              <div className="space-y-2 group">
                ...
                <Textarea {...profileForm.register("bio")} className="rounded-none min-h-[100px] border-slate-200 focus-visible:ring-blue-500/10 focus:border-blue-600 transition-all font-medium italic" placeholder="Expertise, titres académiques..." />
              </div>

              <div className="pt-4 border-t border-slate-100 flex justify-end">
                <Button disabled={isUpdatingProfile} className="bg-blue-600 hover:bg-blue-700 text-white rounded-none px-10 h-14 font-black uppercase text-[10px] tracking-[0.3em] shadow-xl shadow-blue-600/10">
                  {isUpdatingProfile ? <Loader2 className="animate-spin" /> : <span className="flex items-center gap-3"><Save size={16} /> Enregistrer les modifications</span>}
                </Button>
              </div>
           </form>
        </div>
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-2xl overflow-hidden">
           <div className="bg-slate-50 px-8 py-6 border-b border-slate-200 flex items-center justify-between">
              <h3 className="text-lg font-serif font-black uppercase tracking-tighter">Sécurité & Accès</h3>
              <Lock size={18} className="text-slate-400" />
           </div>
           
           <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="p-8 space-y-6">
              <div className="space-y-2 group">
                <label className="text-[10px] uppercase font-black tracking-widest text-slate-400 group-focus-within:text-red-600 transition-colors">Mot de passe actuel</label>
                <Input type="password" {...passwordForm.register("currentPassword")} className="rounded-none h-12 border-slate-200 focus-visible:ring-red-500/10 focus:border-red-600 transition-all" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 group">
                  <label className="text-[10px] uppercase font-black tracking-widest text-slate-400 group-focus-within:text-emerald-600 transition-colors">Nouveau mot de passe</label>
                  <Input type="password" {...passwordForm.register("newPassword")} className="rounded-none h-12 border-slate-200 focus-visible:ring-emerald-500/10 focus:border-emerald-600 transition-all" />
                ...
                <div className="space-y-2 group">
                  <label className="text-[10px] uppercase font-black tracking-widest text-slate-400 group-focus-within:text-emerald-600 transition-colors">Confirmer le nouveau</label>
                  <Input type="password" {...passwordForm.register("confirmPassword")} className="rounded-none h-12 border-slate-200 focus-visible:ring-emerald-500/10 focus:border-emerald-600 transition-all" />
              ...
              <div className="pt-4 border-t border-slate-100">
                <Button disabled={isUpdatingPassword} className="w-full bg-slate-900 hover:bg-black text-white rounded-none h-14 font-black uppercase text-[10px] tracking-[0.4em] transition-all">
                  {isUpdatingPassword ? <Loader2 className="animate-spin" /> : "Réinitialiser les Clés d'Accès"}
                </Button>
              </div>
           </form>
        </div>
