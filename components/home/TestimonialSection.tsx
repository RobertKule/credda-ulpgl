                                ...
                                <CarouselContent className="-ml-6">
                                    {testimonials.map((testi, idx) => (
                                        <CarouselItem key={idx} className="pl-6 md:basis-1/2">
                                            <div className="bg-muted border border-border p-10 lg:p-12 relative group hover:border-primary/30 transition-all duration-700 h-full flex flex-col rounded-none shadow-2xl">
                                                <div className="text-[#C9A84C]/10 absolute top-8 right-8 transition-transform duration-700 group-hover:scale-110">
                                                    <Quote size={64} />
                                                </div>
                                                <p className="text-lg lg:text-xl font-outfit font-light italic leading-relaxed mb-12 relative z-10 flex-1 text-muted-foreground group-hover:text-foreground transition-colors duration-500">
                                                    &ldquo;{testi.text}&rdquo;
                                                </p>
                                                <div className="flex items-center gap-6 mt-auto border-t border-border pt-8">
                                                    <div className="relative w-16 h-16 rounded-sm overflow-hidden border border-border grayscale group-hover:grayscale-0 transition-all duration-700 shrink-0">
                                                        <Image src={testi.image} alt={testi.name} fill className="object-cover" />
                                                    </div>
                                                    <div>
                                                        <h4 className="font-outfit font-bold text-[11px] uppercase tracking-widest text-foreground group-hover:text-primary transition-colors">{testi.name}</h4>
