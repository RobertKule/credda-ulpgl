          ...
          >
            ...
            <div className="absolute top-4 right-4 z-30 flex gap-2">
              <motion.button
                ...
                className="p-3 bg-white/10 backdrop-blur-md text-white hover:bg-blue-600 transition-all rounded-md"
              >
            ...
            <motion.button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 backdrop-blur-md text-white hover:bg-blue-600 transition-all rounded-md z-30"
            >
              <ChevronLeft size={24} />
            </motion.button>
            ...
            <motion.button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 backdrop-blur-md text-white hover:bg-blue-600 transition-all rounded-md z-30"
            >
            ...
            >
              <div className="container mx-auto">
                <div className="flex items-center gap-3 mb-2">
                  <Badge className="bg-blue-600 text-white border-none text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-md">
                ...
                <div className="flex gap-4 mt-6">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 text-sm bg-white/10 hover:bg-blue-600 px-6 py-3 rounded-md transition-all"
                  >
