    ...
    <div className="space-y-10 pb-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 border-b border-slate-200 pb-8">
        ...
        <div className="flex gap-3">
          <Button asChild className="bg-primary hover:bg-blue-700 text-white text-xs font-bold uppercase tracking-widest h-12 px-6 rounded-md shadow-xl transition-all">
